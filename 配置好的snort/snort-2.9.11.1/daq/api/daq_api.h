...
struct _daq_module
{
    ...
    int (*inject) (void *handle, const DAQ_PktHdr_t *hdr, const uint8_t *packet_data, u_int32_t len, int reverse);
    ...
    u_int32_t (*get_capabilities) (void *handle);

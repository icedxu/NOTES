...
extern u_int32_t base64_decode_size;
...
static inline u_int32_t GetHttpBufferMask (void)
{
    return http_mask;
}
...
static inline void SetHttpBufferEncoding (
    HTTP_BUFFER b, const uint8_t* buf, unsigned len, u_int32_t enc)
{

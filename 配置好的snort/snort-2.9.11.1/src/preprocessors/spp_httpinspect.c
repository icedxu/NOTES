...
#endif
static void update_gzip_mempool(bool old_gzip, bool new_gzip, u_int32_t max_sessions);
static void update_fd_mempool(bool old_fd, bool new_fd, u_int32_t max_sessions);
...
static void update_http_mempool(u_int32_t new_memcap, u_int32_t old_memcap);
                                      ...
                                      HTTPINSPECT_GLOBAL_CONF *my_defaultConfig )
{
    ...
    u_int32_t max_sessions = 0;
    u_int32_t block_size = 0;
...
static void update_http_mempool(u_int32_t new_memcap, u_int32_t old_memcap)
{
    u_int32_t max_sessions_logged = 0;
    size_t obj_size = 0;

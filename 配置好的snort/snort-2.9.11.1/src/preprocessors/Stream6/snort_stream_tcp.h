...
extern u_int32_t xtradata_func_count;
...
int StreamUpdateSessionAlertTcp(SessionControlBlock *scb, Packet *p, u_int32_t gid, u_int32_t sid, u_int32_t event_id, u_int32_t event_second);
void StreamSetExtraDataTcp(SessionControlBlock*, Packet*, u_int32_t flag);
void StreamClearExtraDataTcp(SessionControlBlock*, Packet*, u_int32_t flag);

...
typedef struct _stream_api
{
     ...
     *
     */
    int (*update_session_alert)(void *, Packet *p, u_int32_t, u_int32_t, u_int32_t, u_int32_t);
    ...
    void (*set_extra_data)(void*, Packet *, u_int32_t);
    void (*clear_extra_data)(void*, Packet *, u_int32_t);

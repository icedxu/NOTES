...
static int LogPortscanAlert(Packet *p, const char *msg, u_int32_t event_id,
...
static int GeneratePSSnortEvent(Packet *p,u_int32_t gen_id,u_int32_t sig_id,
        u_int32_t sig_rev, u_int32_t class, u_int32_t priority, const char *msg)
{
...
static int GenerateOpenPortEvent(Packet *p, u_int32_t gen_id, u_int32_t sig_id,
        ...
        u_int32_t event_ref, struct timeval *event_time, const char *msg)
{
    Event event;

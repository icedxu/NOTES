...
typedef struct _IPH_API
{
    ...
    u_int32_t   (*iph_ret_id)(const struct _SFSnortPacket *);
    ...
    u_int32_t   (*orig_iph_ret_id)(const struct _SFSnortPacket *);
...
static inline void SetExtraData (SFSnortPacket* p, u_int32_t xid)
{

...
u_int32_t getNumberTailingZerosInBitmask(u_int32_t);
int numBytesInBitmask(u_int32_t );
void RuleOptionBitmaskParse(u_int32_t* , char *, u_int32_t ,char* );

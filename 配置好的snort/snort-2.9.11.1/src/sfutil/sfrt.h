...
typedef struct
{
    ...
    u_int32_t lastAllocatedIndex; /* Index allocated last. Search for unused index
    ...
    tuple_t (*lookup)(u_int32_t* adr, int numAdrDwords, GENERIC tbl);
    int (*insert)(u_int32_t* adr, int numAdrDwords, int len, word index, int behavior, GENERIC tbl);
    void (*free)(GENERIC tbl);
    u_int32_t (*usage)(GENERIC tbl);
    void     (*print)(GENERIC tbl);
    word (*remove)(u_int32_t* adr, int numAdrDwords, int len, int behavior, GENERIC tbl);
} table_t;
/*******************************************************************/

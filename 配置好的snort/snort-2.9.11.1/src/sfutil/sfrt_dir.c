 ...
 */
static inline u_int32_t _dir_remove_all(u_int32_t *allocated, u_int32_t index, u_int32_t fill,
                                 word length, dir_sub_table_t *table)
{
    u_int32_t valueIndex = 0;
 ...
 */
static inline u_int32_t _dir_remove_less_specific(u_int32_t *allocated, int index, int fill,
                                           word length, dir_sub_table_t *table)
{
    u_int32_t valueIndexRet = 0;
    u_int32_t valueIndex = 0;
 ...
 * @param ptr       Information to be associated with this IP range
 * @param master_table    The table that describes all, returned by dir_new */
int sfrt_dir_insert(u_int32_t* adr, int numAdrDwords, int len, word data_index,
...
tuple_t sfrt_dir_lookup(u_int32_t* adr, int numAdrDwords, void *tbl)
{
...
static void _sub_table_print(dir_sub_table_t *sub, u_int32_t level, dir_table_t *table) {
    int index;
 ...
 */
word sfrt_dir_remove(u_int32_t* adr, int numAdrDwords, int len, int behavior, void *table)
{
    dir_table_t *root = (dir_table_t*)table;
    u_int32_t h_adr[4];
    IPLOOKUP iplu;

 ...
 */
int sf_unfold_header(const uint8_t *inbuf, u_int32_t inbuf_size, uint8_t *outbuf,
                          u_int32_t outbuf_size, u_int32_t *output_bytes, int trim_spaces, int *folded)
{
    int num_spaces = 0;
...
int sf_strip_CRLF(const uint8_t *inbuf, u_int32_t inbuf_size, uint8_t *outbuf,
...
int sf_strip_LWS(const uint8_t *inbuf, u_int32_t inbuf_size, uint8_t *outbuf,
          u_int32_t outbuf_size, u_int32_t *output_bytes)
{
    const uint8_t *cursor, *endofinbuf;
    uint8_t *outbuf_ptr;

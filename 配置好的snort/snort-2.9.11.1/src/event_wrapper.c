 ...
 */
int GetSnortEventAction(u_int32_t gid, u_int32_t sid,
                        u_int32_t rev, u_int32_t classification,
                        u_int32_t priority, const char *msg)
{
    OptTreeNode *otn;
    RuleTreeNode *rtn;
...
OptTreeNode *otnCreate(u_int32_t gid, u_int32_t sid, u_int32_t rev,

...
static void TagSession(Packet *, TagData *, u_int32_t, uint16_t, void*);
static void TagHost(Packet *, TagData *, u_int32_t, uint16_t, void*);
static void AddTagNode(Packet *, TagData *, int, u_int32_t, uint16_t, void*);
...
static void TagSession(Packet *p, TagData *tag, u_int32_t time, uint16_t event_id, void* log_list)
{
...
static void TagHost(Packet *p, TagData *tag, u_int32_t time, uint16_t event_id, void* log_list)
{
    int mode;

...
bool Active_SendData(Packet*, EncodeFlags, const uint8_t* buf, u_int32_t len);
void Active_InjectData(Packet*, EncodeFlags, const uint8_t* buf, u_int32_t len);
void Active_UDPInjectData(Packet*, EncodeFlags, const uint8_t* buf, u_int32_t len);

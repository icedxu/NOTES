...
OptTreeNode * SoRuleOtnLookup(SFGHASH *so_rule_otn_map, u_int32_t gid, u_int32_t sid)
{
...
OptTreeNode * SoRuleOtnLookupNext(u_int32_t gid, u_int32_t sid)
{
    OptTreeNode * otn = NULL;
...
OptTreeNode * OtnLookup(SFGHASH *otn_map, u_int32_t gid, u_int32_t sid)
{
    OptTreeNode * otn;
    OtnKey key;

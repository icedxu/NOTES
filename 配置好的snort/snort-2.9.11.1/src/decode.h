...
#ifndef _PseudoPacketType
#define _PseudoPacketType
typedef enum {
    PSEUDO_PKT_IP,
    PSEUDO_PKT_TCP,
    PSEUDO_PKT_DCE_RPKT,
...
typedef int (*LogFunction)(void *ssnptr, uint8_t **buf, u_int32_t *len, u_int32_t *type);
...
#ifndef __CiscoMetaHdr
#define _CiscoMetaHdr
...
#ifndef __CiscoMetaOpt
#define __CiscoMetaOpt
/*
...
#ifndef __IPAddresses
#define __IPAddresses
...
{
    u_int32_t ip6_vtf;               /* 4 bits version, 8 bits TC,
                                        20 bits flow-ID */
...
typedef struct _PGM_NAK_OPT
{
    ...
    uint8_t len;
    uint8_t res[2];
    u_int32_t seq[1];    /* could be many many more, but 1 is sufficient */
} PGM_NAK_OPT;
...
// chained decoders
void DecodeARP(const uint8_t *, u_int32_t, Packet *);
void DecodeEthLoopback(const uint8_t *, u_int32_t, Packet *);
void DecodeVlan(const uint8_t *, const u_int32_t, Packet *);
void DecodePppPktEncapsulated(const uint8_t *, const u_int32_t, Packet *);
void DecodePPPoEPkt(const uint8_t *, const u_int32_t, Packet *);
void DecodeIP(const uint8_t *, const u_int32_t, Packet *);
void DecodeIPV6(const uint8_t *, u_int32_t, Packet *);
void DecodeTCP(const uint8_t *, const u_int32_t, Packet *);
void DecodeUDP(const uint8_t *, const u_int32_t, Packet *);
void DecodeICMP(const uint8_t *, const u_int32_t, Packet *);
void DecodeICMP6(const uint8_t *, const u_int32_t, Packet *);
void DecodeICMPEmbeddedIP(const uint8_t *, const u_int32_t, Packet *);
void DecodeICMPEmbeddedIP6(const uint8_t *, const u_int32_t, Packet *);
void DecodeIPOptions(const uint8_t *, u_int32_t, Packet *);
void DecodeTCPOptions(const uint8_t *, u_int32_t, Packet *);
void DecodeTeredo(const uint8_t *, u_int32_t, Packet *);
void DecodeAH(const uint8_t *, u_int32_t, Packet *);
void DecodeESP(const uint8_t *, u_int32_t, Packet *);
void DecodeGTP(const uint8_t *, u_int32_t, Packet *);

#ifdef GRE
void DecodeGRE(const uint8_t *, const u_int32_t, Packet *);
void DecodeTransBridging(const uint8_t *, const u_int32_t, Packet *);
#endif  /* GRE */
void DecoderAlertEncapsulated(Packet *, int, const char *, const uint8_t *, u_int32_t);

#ifdef MPLS
int isPrivateIP(u_int32_t addr);
void DecodeEthOverMPLS(const uint8_t*, const u_int32_t, Packet*);
void DecodeMPLS(const uint8_t*, const u_int32_t, Packet*);
#endif
...
// chained decoders
void DecodeEAP(const uint8_t *, const u_int32_t, Packet *);
void DecodeEapol(const uint8_t *, u_int32_t, Packet *);
void DecodeEapolKey(const uint8_t *, u_int32_t, Packet *);
void DecodeIPX(const uint8_t *, u_int32_t, Packet *);
#endif  // NO_NON_ETHER_DECODER
...
extern void UpdateDecodeRulesArray(u_int32_t sid, int bOn, int bAll);
...
static inline void SetExtraData (Packet* p, u_int32_t xid)
{

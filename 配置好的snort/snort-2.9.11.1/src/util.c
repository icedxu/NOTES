...
void TimeStop (void)
{
    u_int32_t days = 0, hrs = 0, mins = 0, secs = 0;
    u_int32_t total_secs = 0, tmp = 0;
    uint64_t pps = 0;
    ...
    tmp = total_secs = (u_int32_t)difftime.tv_sec;
...
void PrintPacketData(const uint8_t *data, const u_int32_t len)
{
    u_int32_t i, j;

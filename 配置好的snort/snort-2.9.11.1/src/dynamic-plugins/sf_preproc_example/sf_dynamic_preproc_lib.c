...
#else
#include "..\..\dynamic-examples\dynamic-preprocessor\sf_preproc_info.h"
// F:\Learn\snort - 2.9.8.2\snort - 2.9.8.2\src\dynamic - examples\dynamic - preprocessor\sf_preproc_info.h
#endif

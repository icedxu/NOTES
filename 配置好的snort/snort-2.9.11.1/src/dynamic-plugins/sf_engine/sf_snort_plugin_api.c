...
ENGINE_LINKAGE int storeRuleData(void *p, void *rule_data,
        u_int32_t sid, SessionDataFree sdf)
{
 ...
 *
 */
ENGINE_LINKAGE void *getRuleData(void *p, u_int32_t sid)
{
 ...
 *
 */
int ruleMatchInternal(SFSnortPacket *p, Rule* rule, u_int32_t optIndex, const uint8_t **cursor)
{

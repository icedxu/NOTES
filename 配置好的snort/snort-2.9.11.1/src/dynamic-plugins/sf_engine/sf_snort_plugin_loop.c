...
extern int ruleMatchInternal(SFSnortPacket *p, Rule* rule, u_int32_t optIndex, const uint8_t **cursor);
 ...
 *
 */
int getSizeRemaining(void *p, u_int32_t flags, const uint8_t *cursor)
{
    const uint8_t *start;
    const uint8_t *end;

...
static inline int IsHttpFastPattern (u_int32_t cf)
{
    cf = HTTP_CONTENT(cf);
...
ENGINE_LINKAGE int storeRuleData(void *, void *, u_int32_t, SessionDataFree);
ENGINE_LINKAGE void *getRuleData(void *, u_int32_t);

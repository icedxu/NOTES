...
/****************************************************************************
 *
 * Function: RegisterDynamicRule(Snortconfig *, u_int32_t, u_int32_t, char *,
 *                               void *,
...
int DynamicsfUnfold(const uint8_t *inbuf, u_int32_t insize, uint8_t *outbuf, u_int32_t outsize, u_int32_t *read)
{
    return sf_unfold_header(inbuf, insize, outbuf, outsize, read, 0, 0);
}

int Dynamicsfbase64decode(uint8_t *inbuf, u_int32_t insize, uint8_t *outbuf, u_int32_t outsize, u_int32_t *read)
{

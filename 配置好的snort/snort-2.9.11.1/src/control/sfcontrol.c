...
static void SendResponse(ThreadElement *t, const CSResponseMessage *resp, u_int32_t len)
{
    ssize_t numsent;
...
static int ReadData(ThreadElement *t, uint8_t *buffer, u_int32_t length)
{
    ssize_t numread;
    unsigned total = 0;

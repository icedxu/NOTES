...
void SMTP_Set_flow_id( void *app_data, u_int32_t fid );
...
int SMTP_GetFilename(void *data, uint8_t **buf, u_int32_t *len, u_int32_t *type)
{
...
int SMTP_GetMailFrom(void *data, uint8_t **buf, u_int32_t *len, u_int32_t *type)
{
    SMTP *ssn = SMTP_GetSession(data);
...
int SMTP_GetRcptTo(void *data, uint8_t **buf, u_int32_t *len, u_int32_t *type)
{
    SMTP *ssn = SMTP_GetSession(data);
...
int SMTP_GetEmailHdrs(void *data, uint8_t **buf, u_int32_t *len, u_int32_t *type)
{
    SMTP *ssn = SMTP_GetSession(data);

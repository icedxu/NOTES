...
typedef DCE2_Ret (*DCE2_SmbComFunc)(DCE2_SmbSsnData *, const SmbNtHdr *,
        const DCE2_SmbComInfo *, const uint8_t *, u_int32_t);
...
static u_int32_t DCE2_IgnoreJunkData(const uint8_t *, uint16_t, u_int32_t);
static inline DCE2_Ret DCE2_SmbHandleSegmentation(DCE2_Buffer **,
        const uint8_t *, u_int32_t, u_int32_t);
static inline DCE2_Buffer ** DCE2_SmbGetSegBuffer(DCE2_SmbSsnData *);
static inline u_int32_t * DCE2_SmbGetIgnorePtr(DCE2_SmbSsnData *);
...
static void DCE2_SmbProcessRawData(DCE2_SmbSsnData *, const uint8_t *, u_int32_t);
static DCE2_SmbComInfo * DCE2_SmbCheckCommand(DCE2_SmbSsnData *,
        const SmbNtHdr *, const uint8_t, const uint8_t *, u_int32_t);
static void DCE2_SmbProcessCommand(DCE2_SmbSsnData *, const SmbNtHdr *, const uint8_t *, u_int32_t);
static inline DCE2_Ret DCE2_SmbCheckData(DCE2_SmbSsnData *, const uint8_t *,
        const uint8_t *, const u_int32_t, const uint16_t, const u_int32_t, uint16_t);
static inline DCE2_Ret DCE2_SmbValidateTransactionFields(DCE2_SmbSsnData *, const uint8_t *,
        const uint8_t *, const u_int32_t, const uint16_t, const u_int32_t,
        const u_int32_t, const u_int32_t, const u_int32_t, const u_int32_t,
        const u_int32_t, const u_int32_t, const u_int32_t);
...
static inline DCE2_Ret DCE2_SmbCheckTransDataParams(DCE2_SmbSsnData *,
        const uint8_t *, const uint8_t *, const u_int32_t, const uint16_t,
        const u_int32_t, const u_int32_t, const u_int32_t, const u_int32_t);
static inline DCE2_Ret DCE2_SmbCheckTotalCount(DCE2_SmbSsnData *,
        const u_int32_t, const u_int32_t, const u_int32_t);
static inline void DCE2_SmbCheckFmtData(DCE2_SmbSsnData *, const u_int32_t,
...
static inline DCE2_Ret DCE2_SmbCheckAndXOffset(DCE2_SmbSsnData *, const uint8_t *,
        const uint8_t *, const u_int32_t);
static inline void DCE2_SmbInvalidShareCheck(DCE2_SmbSsnData *,
        const SmbNtHdr *, const uint8_t *, u_int32_t);
static DCE2_Ret DCE2_SmbTransactionGetName(const uint8_t *, u_int32_t, uint16_t, bool);
...
static inline DCE2_Ret DCE2_SmbTransactionReq(DCE2_SmbSsnData *,
        DCE2_SmbTransactionTracker *, const uint8_t *, u_int32_t,
        const uint8_t *, u_int32_t);
...
static inline DCE2_Ret DCE2_SmbTrans2SetFileInfoReq(DCE2_SmbSsnData *,
        const uint8_t *, u_int32_t, const uint8_t *, u_int32_t);
...
void DCE2_SmbSetRdata(DCE2_SmbSsnData *ssd, uint8_t *nb_ptr, uint16_t co_len)
{
    ...
    if (DCE2_SsnFromClient(ssd->sd.wire_pkt))
    {
        SmbWriteAndXReq *writex =
            (SmbWriteAndXReq *)((uint8_t *)smb_hdr + sizeof(SmbNtHdr));
        u_int32_t nb_len = sizeof(SmbNtHdr) + sizeof(SmbWriteAndXReq) + co_len;
    ...
    else
    {
        SmbReadAndXResp *readx =
            (SmbReadAndXResp *)((uint8_t *)smb_hdr + sizeof(SmbNtHdr));
        u_int32_t nb_len = sizeof(SmbNtHdr) + sizeof(SmbReadAndXResp) + co_len;
...
static DCE2_Ret DCE2_NbssHdrChecks(DCE2_SmbSsnData *ssd, const NbssHdr *nb_hdr)
{
    ...
    switch (NbssType(nb_hdr))
    {
        case NBSS_SESSION_TYPE__MESSAGE:
            ...
            {
                u_int32_t nb_len = NbssLen(nb_hdr);
 ...
 *   u_int32_t  -  the amount of data to ignore if there doesn't seem
 *      to be any junk data.  Just use the length as if the bad
 *      NetBIOS header was good.
 *
 * Returns:
 *    u_int32_t - the amount of bytes to ignore as junk.
 *
 ********************************************************************/
static u_int32_t DCE2_IgnoreJunkData(const uint8_t *data_ptr, uint16_t data_len,
        u_int32_t assumed_nb_len)
{
    const uint8_t *tmp_ptr = data_ptr;
    u_int32_t ignore_bytes = 0;
    ...
    while ((tmp_ptr + sizeof(u_int32_t)) <= (data_ptr + data_len))
    {
    ...
    if ((tmp_ptr + sizeof(u_int32_t)) > (data_ptr + data_len))
    {
...
static inline void DCE2_Smb1Process(DCE2_SmbSsnData *ssd)
{
    ...
    u_int32_t *ignore_bytes = DCE2_SmbGetIgnorePtr(ssd);
...
static inline DCE2_Ret DCE2_SmbHandleSegmentation(DCE2_Buffer **buf,
        const uint8_t *data_ptr, u_int32_t add_len, u_int32_t alloc_size)
{
    DCE2_Ret status;
    PROFILE_VARS;
 ...
 *
 ********************************************************************/
static inline u_int32_t * DCE2_SmbGetIgnorePtr(DCE2_SmbSsnData *ssd)
{
    if (DCE2_SsnFromServer(ssd->sd.wire_pkt))
 ...
 *
 ********************************************************************/
static void DCE2_SmbProcessRawData(DCE2_SmbSsnData *ssd, const uint8_t *nb_ptr, u_int32_t nb_len)
{
 ...
 *  u_int32_t          - the remaining length
 *
 * Returns:
 *  DCE2_SmbComInfo *
...
static DCE2_SmbComInfo * DCE2_SmbCheckCommand(DCE2_SmbSsnData *ssd,
        ...
        const uint8_t *nb_ptr, u_int32_t nb_len)
{
    ...
    // Verify there is enough data to do checks
    if (nb_len < (u_int32_t)chk_com_size)
    {
 ...
 *                      structure.
 *  const u_int32_t    - remaining data left in PDU from current pointer.
...
static inline DCE2_Ret DCE2_SmbCheckData(DCE2_SmbSsnData *ssd,
        ...
        const u_int32_t nb_len, const uint16_t bcc,
        const u_int32_t dcnt, uint16_t doff)
{
 ...
 *  const u_int32_t    - reported total data count
 *  const u_int32_t    - reported total parameter count
 *  const u_int32_t    - reported data count
 *  const u_int32_t    - reported data offset
 *  const u_int32_t    - reported data displacement
 *  const u_int32_t    - reported parameter count
 *  const u_int32_t    - reported parameter offset
 *  const u_int32_t    - reported parameter displacement
 *
 * Returns:
 *  DCE2_Ret -  DCE2_RET__ERROR if data should not be processed
 *              DCE2_RET__SUCCESS if data can be processed
...
static inline DCE2_Ret DCE2_SmbValidateTransactionFields(DCE2_SmbSsnData *ssd,
        ...
        const uint8_t *nb_ptr, const u_int32_t nb_len, const uint16_t bcc,
        const u_int32_t tdcnt, const u_int32_t tpcnt,
        const u_int32_t dcnt, const u_int32_t doff, const u_int32_t ddisp,
        const u_int32_t pcnt, const u_int32_t poff, const u_int32_t pdisp)
{
 ...
 * Arguments:
 *  DCE2_SmbSsnData * - SMB session data structure
 *  const u_int32_t    - amount of data sent so far
 *  const u_int32_t    - reported total data count
 *  const u_int32_t    - reported data count
 *  const u_int32_t    - amount of parameters sent so far
 *  const u_int32_t    - reported total parameter count
 *  const u_int32_t    - reported parameter count
 *
 * Returns:
...
static inline DCE2_Ret DCE2_SmbValidateTransactionSent(DCE2_SmbSsnData *ssd,
        u_int32_t dsent, u_int32_t dcnt, u_int32_t tdcnt,
        u_int32_t psent, u_int32_t pcnt, u_int32_t tpcnt)
{
...
static inline DCE2_Ret DCE2_SmbCheckTransDataParams(DCE2_SmbSsnData *ssd,
        const uint8_t *smb_hdr_ptr, const uint8_t *nb_ptr, const u_int32_t nb_len,
        const uint16_t bcc, const u_int32_t dcnt, const u_int32_t doff,
        const u_int32_t pcnt, const u_int32_t poff)
{
 ...
 * Arguments:
 *  DCE2_SmbSsnData * - SMB session data structure
 *  const u_int32_t    - remaining NetBIOS PDU length
...
static inline void DCE2_SmbCheckFmtData(DCE2_SmbSsnData *ssd,
        const u_int32_t nb_len, const uint16_t bcc, const uint8_t fmt,
 ...
 * Arguments:
 *  DCE2_SmbSsnData * - SMB session data structure
 *  const u_int32_t    - total data count
 *  const u_int32_t    - data count/size
 *  const u_int32_t    - data displacement
 *
 * Returns:
...
static inline DCE2_Ret DCE2_SmbCheckTotalCount(DCE2_SmbSsnData *ssd,
        const u_int32_t tcnt, const u_int32_t cnt, const u_int32_t disp)
{
...
static inline DCE2_Ret DCE2_SmbCheckAndXOffset(DCE2_SmbSsnData *ssd,
        const uint8_t *off_ptr, const uint8_t *start_bound, const u_int32_t length)
{
...
static inline void DCE2_SmbInvalidShareCheck(DCE2_SmbSsnData *ssd,
        const SmbNtHdr *smb_hdr, const uint8_t *nb_ptr, u_int32_t nb_len)
{
 ...
 *  u_int32_t                - remaining NetBIOS length
 *
 * Returns:
...
static DCE2_Ret DCE2_SmbOpen(DCE2_SmbSsnData *ssd, const SmbNtHdr *smb_hdr,
        const DCE2_SmbComInfo *com_info, const uint8_t *nb_ptr, u_int32_t nb_len)
{
        ...
        const DCE2_SmbComInfo *com_info, const uint8_t *nb_ptr, u_int32_t nb_len)
{
    ...
    if (DCE2_ComInfoIsRequest(com_info))
    {
        ...
        u_int32_t offset = SmbWriteReqOffset((SmbWriteReq *)nb_ptr);
        ...
        const DCE2_SmbComInfo *com_info, const uint8_t *nb_ptr, u_int32_t nb_len)
{
    ...
    if (DCE2_ComInfoIsRequest(com_info))
    {
        ...
        u_int32_t offset = SmbWriteAndUnlockReqOffset((SmbWriteAndUnlockReq *)nb_ptr);
...
static DCE2_Ret DCE2_SmbTransactionGetName(const uint8_t *nb_ptr,
        u_int32_t nb_len, uint16_t bcc, bool unicode)
{
...
static inline DCE2_Ret DCE2_SmbTransactionReq(DCE2_SmbSsnData *ssd,
        ...
        const uint8_t *data_ptr, u_int32_t data_len,
        const uint8_t *param_ptr, u_int32_t param_len)
{
        ...
        switch (ttracker->subcom)
        {
            ...
            case TRANS_READ_NMPIPE:
                if (!DCE2_BufferIsEmpty(ttracker->dbuf))
                {
                    ...
                    u_int32_t data_len = DCE2_BufferLength(ttracker->dbuf);
        ...
        const DCE2_SmbComInfo *com_info, const uint8_t *nb_ptr, u_int32_t nb_len)
{
    ...
    if (DCE2_ComInfoIsRequest(com_info))
    {
        ...
        u_int32_t offset = SmbWriteAndCloseReqOffset((SmbWriteAndCloseReq *)nb_ptr);
        ...
        if ((u_int32_t)(dcnt + 1) != (u_int32_t)byte_count)
        ...
        const DCE2_SmbComInfo *com_info, const uint8_t *nb_ptr, u_int32_t nb_len)
{
    ...
    else
    {
        ...
        u_int32_t dcnt = SmbReadAndXRespDataCnt((SmbReadAndXResp *)nb_ptr);
        ...
        const DCE2_SmbComInfo *com_info, const uint8_t *nb_ptr, u_int32_t nb_len)
{
    ...
    if (DCE2_ComInfoIsRequest(com_info))
    {
        ...
        u_int32_t dcnt = SmbWriteAndXReqDataCnt((SmbWriteAndXReq *)nb_ptr);
        ...
        case DCE2_POLICY__WIN7:
            ...
            if (!start_write_raw || (ftracker->fp_writex_raw->remaining != 0))
            {
                ...
                if (ftracker->fp_writex_raw->remaining == 0)
                {
                    ...
                    u_int32_t data_len = DCE2_BufferLength(ftracker->fp_writex_raw->buf);
...
static inline DCE2_Ret DCE2_SmbTrans2Open2Req(DCE2_SmbSsnData *ssd,
        const uint8_t *param_ptr, u_int32_t param_len, bool unicode)
{
    ...
    if (DCE2_ComInfoIsRequest(com_info))
    {
        ...
        if (!DCE2_SmbFingerprintedClient(ssd) && DCE2_GcSmbFingerprintClient())
        {
            ...
            if (word_count == 13)
            {
                ...
                if (((u_int32_t)oem_pass_len + uni_pass_len) > nb_len)
                {
        ...
        const DCE2_SmbComInfo *com_info, const uint8_t *nb_ptr, u_int32_t nb_len)
{
    ...
    if (DCE2_ComInfoIsRequest(com_info))
    {
        u_int32_t pcnt = SmbNtTransactReqParamCnt((SmbNtTransactReq *)nb_ptr);
        u_int32_t poff = SmbNtTransactReqParamOff((SmbNtTransactReq *)nb_ptr);
        DCE2_Ret status =
            DCE2_SmbUpdateTransRequest(ssd, smb_hdr, com_info, nb_ptr, nb_len);
    ...
    else
    {
        ...
        {
            u_int32_t poff = SmbNtTransactRespParamOff((SmbNtTransactResp *)nb_ptr);
            u_int32_t pcnt = SmbNtTransactRespParamCnt((SmbNtTransactResp *)nb_ptr);
        ...
        const DCE2_SmbComInfo *com_info, const uint8_t *nb_ptr, u_int32_t nb_len)
{
    ...
    if (DCE2_ComInfoIsResponse(com_info))
    {
        ...
        if (!ftracker->is_ipc)
        {
            const u_int32_t create_disposition =
...
static inline DCE2_Ret DCE2_SmbProcessRequestData(DCE2_SmbSsnData *ssd,
        const uint16_t fid, const uint8_t *data_ptr, u_int32_t data_len, uint64_t offset)
{
    DCE2_SmbFileTracker *ftracker = DCE2_SmbGetFileTracker(ssd, fid);
...
static inline SFSnortPacket * DCE2_SmbGetRpkt(DCE2_SmbSsnData *ssd,
        const uint8_t **data, u_int32_t *data_len, DCE2_RpktType rtype)
{
    SFSnortPacket *rpkt;
    uint16_t header_len;
...
static DCE2_Ret DCE2_SmbUpdateTransRequest(DCE2_SmbSsnData *ssd,
        ...
        const uint8_t *nb_ptr, u_int32_t nb_len)
{
    u_int32_t tpcnt, pcnt, poff;
    u_int32_t tdcnt, dcnt, doff;
    uint16_t com_size = DCE2_ComInfoCommandSize(com_info);
    uint16_t byte_count = DCE2_ComInfoByteCount(com_info);
    uint16_t fid;
    uint8_t setup_count;
        ...
        const uint8_t *nb_ptr, u_int32_t nb_len)
{
    uint16_t com_size = DCE2_ComInfoCommandSize(com_info);
    uint16_t byte_count = DCE2_ComInfoByteCount(com_info);
    u_int32_t tdcnt, doff, dcnt, ddisp;
    u_int32_t tpcnt, poff, pcnt, pdisp;
    DCE2_SmbTransactionTracker *ttracker = &ssd->cur_rtracker->ttracker;
...
static DCE2_Ret DCE2_SmbUpdateTransResponse(DCE2_SmbSsnData *ssd,
        ...
        const uint8_t *nb_ptr, u_int32_t nb_len)
{
    u_int32_t tpcnt, pcnt, poff, pdisp;
    u_int32_t tdcnt, dcnt, doff, ddisp;
    DCE2_SmbTransactionTracker *ttracker = &ssd->cur_rtracker->ttracker;
    uint16_t sub_com = ttracker->subcom;
    int data_params = DCE2_SMB_TRANS__NONE;
    uint8_t smb_com = DCE2_ComInfoSmbCom(com_info);
...
static DCE2_Ret DCE2_SmbFileAPIProcess(DCE2_SmbSsnData *ssd,
        ...
        u_int32_t data_len, bool upload)
{
...
static uint8_t* DCE2_SmbGetString(const uint8_t *data,
        u_int32_t data_len, bool unicode, uint16_t *file_name_len)
{
    uint8_t *fname = NULL;
    u_int32_t i = 0;

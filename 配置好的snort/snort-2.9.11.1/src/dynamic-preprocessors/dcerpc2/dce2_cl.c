...
typedef struct _DCE2_ClFragTracker
{
    ...
    u_int32_t iface_vers; /* only set on first fragment received */
...
{
    u_int32_t seq_num = DceRpcClSeqNum(cl_hdr);

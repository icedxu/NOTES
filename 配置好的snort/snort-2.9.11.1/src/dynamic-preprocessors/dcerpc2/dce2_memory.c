 ...
 ********************************************************************/
static void DCE2_RegMemSmb(u_int32_t, DCE2_MemType);
static void DCE2_RegMemCo(u_int32_t, DCE2_MemType);
static void DCE2_RegMemCl(u_int32_t, DCE2_MemType);
static int DCE2_CheckMemcap(u_int32_t, DCE2_MemType);
 ...
 *
 ********************************************************************/
void DCE2_RegMem(u_int32_t size, DCE2_MemType mtype)
{
    switch (mtype)
    {
 ...
 *
 ********************************************************************/
static void DCE2_RegMemSmb(u_int32_t size, DCE2_MemType mtype)
{
    switch (mtype)
    {
        case DCE2_MEM_TYPE__SMB_SSN:
 ...
 *
 ********************************************************************/
static void DCE2_RegMemCo(u_int32_t size, DCE2_MemType mtype)
{
    switch (mtype)
    {
        case DCE2_MEM_TYPE__CO_SEG:
 ...
 *
 ********************************************************************/
static void DCE2_RegMemCl(u_int32_t size, DCE2_MemType mtype)
{
    switch (mtype)
    {
        case DCE2_MEM_TYPE__CL_ACT:
 ...
 *
 ********************************************************************/
void DCE2_UnRegMem(u_int32_t size, DCE2_MemType mtype)
{
    switch (mtype)
    {
        case DCE2_MEM_TYPE__CONFIG:
 ...
 *
 ********************************************************************/
static int DCE2_CheckMemcap(u_int32_t size, DCE2_MemType mtype)
{
    switch (mtype)
    {
 ...
 *
 ********************************************************************/
void * DCE2_Alloc(u_int32_t size, DCE2_MemType mtype)
{
    void *mem;
 ...
 *
 ********************************************************************/
void DCE2_Free(void *mem, u_int32_t size, DCE2_MemType mtype)
{
    if (mem == NULL)
        return;
 ...
 *
 ********************************************************************/
void * DCE2_ReAlloc(void *old_mem, u_int32_t old_size, u_int32_t new_size, DCE2_MemType mtype)
{
    void *new_mem;
    DCE2_Ret status;

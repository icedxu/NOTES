...
static inline u_int32_t DCE2_BufferSize(DCE2_Buffer *);
static inline u_int32_t DCE2_BufferLength(DCE2_Buffer *);
static inline void DCE2_BufferSetLength(DCE2_Buffer *, u_int32_t);
static inline uint8_t * DCE2_BufferData(DCE2_Buffer *);
static inline u_int32_t DCE2_BufferMinAllocSize(DCE2_Buffer *);
static inline void DCE2_BufferSetMinAllocSize(DCE2_Buffer *, u_int32_t);

static inline char * DCE2_PruneWhiteSpace(char *);
static inline int DCE2_IsEmptyStr(char *);
static inline DCE2_Ret DCE2_Memcpy(void *, const void *, u_int32_t, const void *, const void *);
static inline DCE2_Ret DCE2_Memmove(void *, const void *, u_int32_t, const void *, const void *);
 ...
 ********************************************************************/
DCE2_Buffer * DCE2_BufferNew(u_int32_t, u_int32_t, DCE2_MemType);
DCE2_Ret DCE2_BufferAddData(DCE2_Buffer *, const uint8_t *,
        u_int32_t, u_int32_t, DCE2_BufferMinAddFlag);
DCE2_Ret DCE2_BufferMoveData(DCE2_Buffer *, u_int32_t, const uint8_t *, u_int32_t);
 ...
 *
 *********************************************************************/
static inline u_int32_t DCE2_BufferSize(DCE2_Buffer *buf)
{
 ...
 *
 *********************************************************************/
static inline u_int32_t DCE2_BufferLength(DCE2_Buffer *buf)
{
    if (buf == NULL) return 0;
    return buf->len;
}
 ...
 *
 *********************************************************************/
static inline u_int32_t DCE2_BufferOffset(DCE2_Buffer *buf)
{
    if (buf == NULL) return 0;
    return buf->offset;
}
 ...
 *
 *********************************************************************/
static inline void DCE2_BufferSetLength(DCE2_Buffer *buf, u_int32_t len)
{
    if (buf == NULL) return;
 ...
 *
 *********************************************************************/
static inline u_int32_t DCE2_BufferMinAllocSize(DCE2_Buffer *buf)
{
    if (buf == NULL) return 0;
 ...
 *
 *********************************************************************/
static inline void DCE2_BufferSetMinAllocSize(DCE2_Buffer *buf, u_int32_t size)
{
    if (buf == NULL) return;
 ...
 *
 ********************************************************************/
static inline DCE2_Ret DCE2_Memcpy(void *dst, const void *src, u_int32_t len,
 ...
 *
 ********************************************************************/
static inline DCE2_Ret DCE2_Memmove(void *dst, const void *src, u_int32_t len,
                                    const void *dst_start, const void *dst_end)
{

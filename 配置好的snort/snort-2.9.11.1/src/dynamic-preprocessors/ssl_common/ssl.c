...
static u_int32_t SSL_decode_version_v3(uint8_t major, uint8_t minor)
{
...
static u_int32_t SSL_decode_handshake_v3(const uint8_t *pkt , int size, 
...
static u_int32_t SSL_decode_v3(const uint8_t *pkt, int size, u_int32_t pkt_flags, uint8_t *alert_flags, uint16_t *partial_rec_len, int max_hb_len)
{
    SSL_record_t *record;
    u_int32_t retval = 0;
    uint16_t reclen;
...
static u_int32_t SSL_decode_v2(const uint8_t *pkt, int size, u_int32_t pkt_flags)
{
    uint16_t reclen;
...
u_int32_t SSL_decode(const uint8_t *pkt, int size, u_int32_t pkt_flags, u_int32_t prev_flags, uint8_t *alert_flags, uint16_t *partial_rec_len, int max_hb_len)
{
    SSL_record_t *record;
    uint16_t reclen;
    u_int32_t datalen;

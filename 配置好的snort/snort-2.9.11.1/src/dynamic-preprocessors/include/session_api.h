...
{
    u_int32_t tcp_session_limit;
    u_int32_t udp_session_limit;
    u_int32_t icmp_session_limit;
    u_int32_t ip_session_limit;
} StreamSessionLimits;
...
//typedef void (*LogExtraData)(void *ssnptr, void *config, LogFunction *funcs, u_int32_t max_count,
//                             u_int32_t xtradata_mask, u_int32_t id, u_int32_t sec);

#ifdef ENABLE_HA
typedef u_int32_t ( *StreamHAProducerFunc )( void *ssnptr, uint8_t *buf );
...
typedef char** (*GetHttpXffPrecedenceFunc)(void* ssn, u_int32_t flags, int* nFields);
...
typedef struct _session_api
{
    int version;
      ...
      */
     struct _SessionCache* (*init_session_cache)(u_int32_t, u_int32_t, SessionCleanup);
     ...
     */
      ...
      *    Session Control Block
     */
     void (*remove_session_from_oneway_list)( u_int32_t, void * );
      ...
      *
      */
     int (*delete_session_cache)( u_int32_t protocol );
      ...
      *
      */
     int (*prune_session_cache)(struct _SessionCache*, u_int32_t, void *, int);
      ...
      *
      */
     void (*clean_protocol_session_pool)( u_int32_t );
      ...
      *     Session Pointer
      */
     void (*free_protocol_session_pool)( u_int32_t, void * );
      ...
      *     protocol
      */
     void *(*alloc_protocol_session)( u_int32_t );
      ...
      *      protocol
      */
     u_int32_t (*get_session_prune_count)( u_int32_t protocol );
      ...
      *     protocol
      */
     void (*reset_session_prune_count)( u_int32_t protocol );
      ...
      *     Current time
     */
    void (*check_session_timeout)( u_int32_t, time_t );
     ...
     *     Packet
     */
    u_int32_t (*get_packet_direction)(SFSnortPacket *);
   ...
   /* Turn off inspection for potential session.
    ...
    int (*ignore_session)(const SFSnortPacket *, sfaddr_t*, uint16_t, sfaddr_t*, uint16_t, uint8_t,
                          u_int32_t, char, char, struct _ExpectNode**);
   ...
   /* Set a reference to application data for a session
     ...
     *     -1 on failure
     */
    int (*set_application_data)(void *, u_int32_t, void *, StreamAppDataFree);
     ...
     *     timeout
     */
    void (*set_expire_timer)( SFSnortPacket *, void *, u_int32_t );
    ...
    */
     ...
     *      Application ID
     */
    void (*register_service_handler)(u_int32_t, int16_t);
     ...
     *  u_int32_t - direction. Valid values are SSN_DIR_SERVER or SSN_DIR_CLIENT
     *
     * Returns
     *  IP address. Contents at the buffer should not be changed. The
     */
     sfaddr_t*  (*get_session_ip_address)(void *, u_int32_t);
    ...
    int (*set_application_protocol_id_expected)(const SFSnortPacket *, sfaddr_t*, uint16_t, sfaddr_t*, uint16_t,
                uint8_t, int16_t, u_int32_t, void*, void (*)(void*), struct _ExpectNode**);
     ...
     *      < 0 on failure
     */
    int (*register_ha_funcs)(u_int32_t preproc_id, uint8_t subcode, uint8_t size,
     ...
     *      Subcode
     */
    void (*unregister_ha_funcs)(u_int32_t preproc_id, uint8_t subcode);
     ...
     *      Application Protocol
     */
    void *(*get_application_data_from_key)(const StreamSessionKey *, u_int32_t);
    ...
    void *(*get_application_data_from_ip_port)(sfaddr_t*, uint16_t, sfaddr_t*, uint16_t, char,
                                               uint16_t, u_int32_t, uint16_t, u_int32_t);

    void (*disable_preproc_for_session)( void *, u_int32_t );
    void (*enable_preproc_for_port)( struct _SnortConfig *, u_int32_t, u_int32_t, uint16_t );
    void (*enable_preproc_all_ports)( struct _SnortConfig *, u_int32_t, u_int32_t );
    void (*enable_preproc_all_ports_all_policies)( struct _SnortConfig *, u_int32_t, u_int32_t );
    bool (*is_preproc_enabled_for_port)( u_int32_t, uint16_t );
    ...
    void* (*get_application_data_from_expected_node)(struct _ExpectNode*, u_int32_t);
    int (*add_application_data_to_expected_node)(struct _ExpectNode*, u_int32_t, void*, void (*)(void*));
    void (*register_get_http_xff_precedence)(GetHttpXffPrecedenceFunc );
    char** (*get_http_xff_precedence)(void* ssn, u_int32_t flags, int* nFields);

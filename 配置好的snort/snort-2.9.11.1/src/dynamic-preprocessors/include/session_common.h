...
typedef struct _SessionConfiguration
{
    ...
    u_int32_t   min_response_seconds;
...
#endif
    u_int32_t  numSnortPolicies;
    u_int32_t  *policy_ref_count;
#ifdef SNORT_RELOAD
...
int SessionTrackingEnabled( SessionConfiguration *config, u_int32_t protocol );
u_int32_t GetSessionPruneLogMax( void );
u_int32_t GetSessionMemCap( void );
...
extern u_int32_t session_mem_in_use;

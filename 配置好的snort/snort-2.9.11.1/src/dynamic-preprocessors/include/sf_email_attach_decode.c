...
int sf_qpdecode(char *src, u_int32_t slen, char *dst, u_int32_t dlen, u_int32_t *bytes_read, u_int32_t *bytes_copied )
{
    char ch;
...
int sf_uudecode(uint8_t *src, u_int32_t slen, uint8_t *dst, u_int32_t dlen, u_int32_t *bytes_read, u_int32_t *bytes_copied, uint8_t *begin_found, uint8_t *end_found, uint8_t *file_name, u_int32_t *fname_len, bool fname_present_already)
{
    uint8_t *sod;
    int sol = 1, length = 0;
    uint8_t *ptr, *end, *dptr, *dend, *tptr = NULL;
    uint8_t *filename = NULL, *space = NULL;
    u_int32_t  tlen = 0, fname_length = 0;
...
{
    u_int32_t encode_avail = 0, decode_avail = 0 ;
    uint8_t *encode_buf, *decode_buf;
    u_int32_t act_encode_size = 0, act_decode_size = 0;
    u_int32_t prev_bytes = 0;
    u_int32_t i = 0;
...
int QPDecode(const uint8_t *start, const uint8_t *end, Email_DecodeState *ds)
{
    u_int32_t encode_avail = 0, decode_avail = 0 ;
    uint8_t *encode_buf, *decode_buf;
    u_int32_t act_encode_size = 0, act_decode_size = 0, bytes_read = 0;
    u_int32_t prev_bytes = 0;
    u_int32_t i = 0;
...
int UUDecode(const uint8_t *start, const uint8_t *end, Email_DecodeState *ds, uint8_t *filename, u_int32_t *fname_length, bool fname_present)
{
    u_int32_t encode_avail = 0, decode_avail = 0 ;
    uint8_t *encode_buf, *decode_buf;
    u_int32_t act_encode_size = 0, act_decode_size = 0, bytes_read = 0;
    ...
    if((u_int32_t)(end- start) > encode_avail)
...
{
    u_int32_t bytes_avail = 0;
    u_int32_t act_size = 0;
    ...
    if( (u_int32_t)(end-start) < bytes_avail )
    {
        act_size = ( end - start);
    }
    else
...
int EmailDecode(const uint8_t *start, const uint8_t *end, Email_DecodeState *ds,  uint8_t *filename, u_int32_t *fname_size, bool filename_present)
{

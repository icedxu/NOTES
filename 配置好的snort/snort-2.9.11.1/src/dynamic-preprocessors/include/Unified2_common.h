...
typedef struct _Unified2IDSEvent
{
    ...
    u_int32_t event_microsecond;
    u_int32_t signature_id;
    u_int32_t generator_id;
    u_int32_t signature_revision;
...
typedef struct _Serial_Unified2Packet
{
    ...
    u_int32_t event_id;
    u_int32_t event_second;
    u_int32_t packet_second;
    u_int32_t packet_microsecond;
    u_int32_t linktype;
...
typedef struct _SerialUnified2ExtraData{
    ...
    u_int32_t event_id;
    u_int32_t event_second;
    u_int32_t type;              /* EventInfo */
    u_int32_t data_type;         /*EventDataType */
    u_int32_t blob_length;       /* Length of the data + sizeof(blob_length) + sizeof(data_type)*/

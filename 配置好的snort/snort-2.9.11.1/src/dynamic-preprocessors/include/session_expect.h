...
void StreamExpectInit(u_int32_t maxExpectations);
void StreamExpectCleanup(void);

struct _ExpectNode* getNextExpectedNode(struct _ExpectNode* expectedNode);
void* getApplicationDataFromExpectedNode(struct _ExpectNode* expectedNode, u_int32_t preprocId);
int addApplicationDataToExpectedNode(struct _ExpectNode* expectedNode, u_int32_t preprocId,
                                     void *appData, void (*appDataFreeFn)(void*));

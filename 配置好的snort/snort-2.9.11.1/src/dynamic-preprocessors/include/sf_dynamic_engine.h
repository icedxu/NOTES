...
typedef int (*SfUnfold)(const uint8_t *, u_int32_t , uint8_t *, u_int32_t , u_int32_t *);
typedef int (*SfBase64Decode)(uint8_t *, u_int32_t , uint8_t *, u_int32_t , u_int32_t *);
...
typedef int (*SetRuleData)(void *, void *, u_int32_t, SessionDataFree);
typedef void *(*GetRuleData)(void *, u_int32_t);

...
typedef struct s_MAIL_LogConfig
{
    ...
    char  log_filename;
    char  log_email_hdrs;
    u_int32_t   email_hdrs_log_depth;
}MAIL_LogConfig;
...
static inline bool scanning_boundary(MimeDataPafInfo *mime_info, u_int32_t boundary_start, u_int32_t* fp)
{
    if (boundary_start &&

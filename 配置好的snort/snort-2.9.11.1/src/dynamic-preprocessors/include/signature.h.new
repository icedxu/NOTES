...
struct _OptTreeNode * SoRuleOtnLookup(SFGHASH *, u_int32_t gid, u_int32_t sid);
struct _OptTreeNode * SoRuleOtnLookupNext(u_int32_t gid, u_int32_t sid);
void SoRuleOtnLookupFree(SFGHASH *);

SFGHASH * OtnLookupNew(void);
void OtnLookupAdd(SFGHASH *, struct _OptTreeNode *);
struct _OptTreeNode * OtnLookup(SFGHASH *, u_int32_t gid, u_int32_t sid);

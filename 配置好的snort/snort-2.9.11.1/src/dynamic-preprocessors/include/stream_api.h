...
typedef void (*LogExtraData)(void *ssnptr, void *config, LogFunction *funcs, u_int32_t max_count, u_int32_t xtradata_mask, u_int32_t id, u_int32_t sec);
...
typedef PAF_Status (*PAF_Callback)(  /* return your scan state */
    ...
    u_int32_t* fp,          /* flush point (offset) relative to data */
    u_int32_t * fp_eoh      /* flush point (offset) at end-of-header */
);
...
typedef struct _stream_api
{
     ...
     *
     */
    int (*add_session_alert)(void *, SFSnortPacket *p, u_int32_t, u_int32_t);
     ...
     */
    int (*check_session_alerted)(void *, SFSnortPacket *p, u_int32_t, u_int32_t);
     ...
     *
     */
    int (*update_session_alert)(void *, SFSnortPacket *p, u_int32_t, u_int32_t, u_int32_t, u_int32_t);
     ...
     */
    u_int32_t (*get_flush_point)(void *, char);
     ...
     *  void * - session pointer
     *  char - direction
     *  u_int32_t - flush point size
     */
    void (*set_flush_point)(void *, char, u_int32_t);
    ...
    void (*set_extra_data)(void*, SFSnortPacket *, u_int32_t);
    void (*clear_extra_data)(void*, SFSnortPacket *, u_int32_t);
...
//
    ...
    int (*set_application_protocol_id_expected_preassign_callback)(const SFSnortPacket *, sfaddr_t*, uint16_t,
                sfaddr_t*, uint16_t, uint8_t, int16_t, u_int32_t, void*, void (*)(void*), unsigned, Stream_Event,
                struct _ExpectNode**);
     ...
     *    ssnptr - sesssion pointer
     */
    u_int32_t (*get_preproc_flags)(void *ssnptr);

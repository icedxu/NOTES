...
typedef void * (*AddPreprocFunc)(struct _SnortConfig *, void (*pp_func)(void *, void *), uint16_t, u_int32_t, u_int32_t);
typedef void * (*AddMetaEvalFunc)(struct _SnortConfig *, void (*meta_eval_func)(int, const uint8_t *),
                                  uint16_t priority, u_int32_t preproc_id);
typedef void (*AddPreprocExit)(void (*pp_exit_func) (int, void *), void *arg, uint16_t, u_int32_t);
typedef void (*AddPreprocUnused)(void (*pp_unused_func) (int, void *), void *arg, uint16_t, u_int32_t);
...
typedef int (*AlertQueueAdd)(u_int32_t, u_int32_t, u_int32_t,
                             u_int32_t, u_int32_t, const char *, void *);
typedef u_int32_t (*GenSnortEvent)(SFSnortPacket *p, u_int32_t gid, u_int32_t sid, u_int32_t rev,
                                  u_int32_t classification, u_int32_t priority, const char *msg);
#ifdef SNORT_RELOAD
...
typedef int (*EnablePreprocessorFunc)(void *, u_int32_t);
...
typedef void (*AddPreprocReset)(void (*pp_rst_func) (int, void *), void *arg, uint16_t, u_int32_t);
typedef void (*AddPreprocResetStats)(void (*pp_rst_stats_func) (int, void *), void *arg, uint16_t, u_int32_t);
...
typedef int (*IsPreprocEnabledFunc)(struct _SnortConfig *, u_int32_t);
...
typedef int (*EncodeFormat)(u_int32_t, const void*, void*, int);
...
typedef int (*SCPreallocMessageTXFunc)(u_int32_t length, SCMsgHdr **hdr, uint8_t **msg_ptr, void **msg_handle);
typedef int (*SCEnqueueMessageTXFunc)(SCMsgHdr *hdr, const uint8_t *msg, u_int32_t length, void *msg_handle, SCMQMsgFreeFunc msgFreeFunc);
#endif
...
typedef void (*DynamicSendBlockResponse)(void *packet, const uint8_t* buffer, u_int32_t buffer_len, unsigned flags);
typedef void (*ActiveInjectDataFunc)(void *, u_int32_t, const uint8_t *, u_int32_t);
typedef void (*ActiveResponseFunc )(void *, const uint8_t *, u_int32_t , u_int32_t);
...
#endif
typedef int (*DynamicSetFlowId)(const void* p, u_int32_t id);
...
typedef void (*AddPeriodicCheck)(void (*pp_check_func) (int, void *), void *arg, uint16_t, u_int32_t, u_int32_t);
...
typedef int (*UserGroupIdGetFunc)(void *ssnptr, u_int32_t *userId, u_int32_t *realmId, unsigned *groupIdArray, unsigned groupIdArrayLen);
...
typedef void (*UpdateSSLSSnLogDataFunc)(void *ssnptr, uint8_t logging_on, uint8_t action_is_block, const char *ssl_cert_fingerprint,
            u_int32_t ssl_cert_fingerprint_len, u_int32_t ssl_cert_status, uint8_t *ssl_policy_id,
            u_int32_t ssl_policy_id_len, u_int32_t ssl_rule_id, uint16_t ssl_cipher_suite, uint8_t ssl_version,
            uint16_t ssl_actual_action, uint16_t ssl_expected_action, u_int32_t ssl_url_category,
            uint16_t ssl_flow_status, u_int32_t ssl_flow_error, u_int32_t ssl_flow_messages,
...
typedef void (*EndSSLSSnLogDataFunc)(void *ssnptr, u_int32_t ssl_flow_messages, uint64_t ssl_flow_flags) ;

...
static void SIP_ParseMethods(char **, u_int32_t *,SIPMethodlist*);
 ...
 *
 ********************************************************************/
static void SIP_ParseMethods(char **ptr, u_int32_t *methodsConfig, SIPMethodlist* pmethods)
{
    char* cur_tokenp = *ptr;
...
void ParseSIPArgs(SIPConfig *config, u_char* argp)
{
    ...
    while ( cur_sectionp )
    {
        ...
        {
            cur_tokenp = strtok( NULL, SIP_CONFIG_VALUE_SEPERATORS);
            config->maxNumSessions = (u_int32_t)ParseNumInRange(cur_tokenp,
        ...
        {
            cur_tokenp = strtok( NULL, SIP_CONFIG_VALUE_SEPERATORS);
            config->maxNumDialogsInSession = (u_int32_t)ParseNumInRange(cur_tokenp,
 ...
 *
 ********************************************************************/
SIPMethodNode*  SIP_AddUserDefinedMethod(char *methodName, u_int32_t *methodsConfig, SIPMethodlist* pmethods)
{

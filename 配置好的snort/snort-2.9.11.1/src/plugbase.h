...
typedef struct _DetectionEvalFuncNode
{
    ...
    uint16_t priority;
    u_int32_t detect_id;
    //u_int32_t detect_bit;
    u_int32_t proto_mask;
    union
    {
...
DetectionEvalFuncNode * AddFuncToDetectionList(struct _SnortConfig *, DetectionEvalFunc, uint16_t, u_int32_t, u_int32_t);
...
PreprocEvalFuncNode * AddFuncToPreprocList(struct _SnortConfig *, PreprocEvalFunc, uint16_t, u_int32_t, u_int32_t);
...
PreprocMetaEvalFuncNode * AddFuncToPreprocMetaEvalList(struct _SnortConfig *, PreprocMetaEvalFunc, uint16_t, u_int32_t);
void AddFuncToPreprocCleanExitList(PreprocSignalFunc, void *, uint16_t, u_int32_t);
void AddFuncToPreprocShutdownList(PreprocSignalFunc, void *, uint16_t, u_int32_t);
void AddFuncToPreprocResetList(PreprocSignalFunc, void *, uint16_t, u_int32_t);
void AddFuncToPreprocResetStatsList(PreprocSignalFunc, void *, uint16_t, u_int32_t);
int IsPreprocEnabled(struct _SnortConfig *, u_int32_t);
...
void AddFuncToPeriodicCheckList(PeriodicFunc, void *, uint16_t, u_int32_t, u_int32_t);

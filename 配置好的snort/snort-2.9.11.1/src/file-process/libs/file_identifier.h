...
{
    u_int32_t type_id;           /* magic content to match*/
    IdNodeState state;
    u_int32_t offset;            /* offset from file start */
 ...
 * Args: None
 * Return:
 *   u_int32_t: memory usage in bytes
 */
u_int32_t file_identifiers_usage(void);
 ...
 * Return:
 *   u_int32_t: file type ID
 */
u_int32_t file_identifiers_match(uint8_t *buf, int len, FileContext *cxt);

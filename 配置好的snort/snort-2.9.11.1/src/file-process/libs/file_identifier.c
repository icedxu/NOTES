...
u_int32_t memory_used = 0; /*Track memory usage*/
...
static inline IdentifierNode *create_trie_from_magic(MagicData **head, u_int32_t type_id)
{
    int i;
 ...
 */
u_int32_t file_identifiers_match(uint8_t *buf, int len, FileContext *context)
{
    IdentifierNode * current;
    uint64_t end;

...
static inline void
__add_id_to_list( u_int32_t **list, u_int32_t *list_size, const u_int32_t id )
{
    u_int32_t *_temp;
...
bool get_ids_from_type(const FileConfig* file_config, const char *type, u_int32_t **ids,
        u_int32_t *count)
{
    bool status = false;
    int i;
...
bool get_ids_from_group(const FileConfig* file_config, const char *group, u_int32_t **ids,
        u_int32_t *count)
{
    bool status = false;
    int i;
...
RuleInfo *file_rule_get(FileConfig* file_config, u_int32_t id)
{
    if (file_config)
    {

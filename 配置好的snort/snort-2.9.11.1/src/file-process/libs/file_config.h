...
bool get_ids_from_type( const FileConfig* conf, const char * type, u_int32_t ** ids, u_int32_t * count );
...
bool get_ids_from_group( const FileConfig* conf, const char * group, u_int32_t ** ids, u_int32_t * count );
 ...
 * Args:
 *   void *file_config: pointer to file config
 *   u_int32_t rule_id: file rule ID
 */
RuleInfo *file_rule_get(FileConfig* conf, u_int32_t rule_id);

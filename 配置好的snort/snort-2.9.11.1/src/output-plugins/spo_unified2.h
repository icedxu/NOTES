...
typedef struct _PESessionEndRecord
{
    ...
    u_int32_t    policyengine_ruleId;
    u_int32_t    policyengine_ruleAction;
    ...
    u_int32_t    firstPktsecond;
    u_int32_t    lastPktsecond;
    uint64_t    initiatorPkts;
    uint64_t    responderPkts;
    uint64_t    initiatorBytes;
    uint64_t    responderBytes;
    u_int32_t    appProtoId;
    u_int32_t    webAppId;
    u_int32_t    userId;
    u_int32_t    urlCategory;
    u_int32_t    urlReputation;
    u_int32_t    clientId;

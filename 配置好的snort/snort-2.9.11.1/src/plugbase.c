...
DetectionEvalFuncNode * AddFuncToDetectionList(SnortConfig *sc,
                                            ...
                                            uint16_t priority, u_int32_t detect_id,
...
static void AddFuncToPreprocSignalList(PreprocSignalFunc, void *,
                                       PreprocSignalFuncNode **, uint16_t, u_int32_t);
...
int IsPreprocEnabled(SnortConfig *sc, u_int32_t preproc_id)
{
...
void AddFuncToPeriodicCheckList(PeriodicFunc periodic_func, void *arg,
        uint16_t priority, u_int32_t preproc_id, u_int32_t period )
{
